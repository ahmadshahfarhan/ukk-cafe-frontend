...
export default function Meja() {
    ...
    return (
        <div>
            <div className="ml-60 mt-40 my-8 mx-16">
                <div>
                                ...
                                {meja && meja.map((meja, index) => (
                                    <tr key={meja.id} className="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td className="pl-6 py-4 inline-flex text-right ">
                                            ...
                                            <a onClick={() => selectIdDelete(meja.id)}>
            ...
            {showModalEdit ? (
                <div>
                    ...
                    <div className="opacity-25 inset-0  bg-black"></div>
                </div>
            ) : null}
        </div>
